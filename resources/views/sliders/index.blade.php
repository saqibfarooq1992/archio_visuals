            ...
            <div class="card my-4">
              ...
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3 row">
                <div class="col-6 d-flex align-items-center">
                    <h6 class="text-white text-capitalize ps-3">Home Slider</h6>
                </div>
                <div class="col-6 text-end">
                    <a class="btn btn-sm bg-gradient-dark mb-0" href="{{ route('sliders.create') }}"><i class="material-icons text-sm">add</i>&nbsp;&nbsp;Home Slider</a>
                </div>
            </div
              </div>
