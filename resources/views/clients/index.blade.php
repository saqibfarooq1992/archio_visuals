            ...
            <div class="card my-4">
              ...
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3 row">
                ...
                <div class="col-6 text-end">
                    <a class="btn btn-sm bg-gradient-dark mb-0" href="{{ route('clients.create') }}"><i class="material-icons text-sm">add</i>&nbsp;&nbsp;Clients</a>
                </div>
            </div
              </div>
                  ...
                  <table class="table align-items-center mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-left">{{$item->designation}} Cat</td>
