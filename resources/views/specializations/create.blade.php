        ...
        <div class="row">
            <div class="col-lg-6 col-md-8 col-12 mx-auto">
                ...
                <div class="card-body row">
                    <form role="form" action="{{route('specializations.store')}}" method="POST" class="text-start" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="input-group input-group-outline mb-3">
                                    <textarea name="detail_description" placeholder="Detail Description...." class="form-control" id="detail_description" cols="30" rows="5" autocomplete="detail_description"></textarea>
                                </div>
                            </div>
                        </div>
                        <br>
