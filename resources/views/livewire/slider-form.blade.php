<div>
  <h4 class="mb-4 text-2xl font-bold">Slider</h4>
    <div>
        <div class="container mx-auto">
            <form method="POST" wire:submit.prevent="storeSlider" >
                ...
                <div>
                    ...
                    <input type="file" wire:model.lazy="slider" class="w-full py-2 rounded">
                    @error('title')
                    <span class="text-red-600">{{ $message }}</span>
                    @enderror
                </div>
                    ...
                    <table class="min-w-full">
                        ...
                        <tbody class="bg-white">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 border-b border-gray-200">
                                    <button wire:click="edit({{ $slider->id }})" class="px-4 py-2 text-white bg-blue-600">
                                        Edit
                                    </button>
                                </td>
